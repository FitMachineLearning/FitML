'''
Lunar Lander Solution by Michel Aka
https://github.com/FitMachineLearning/FitML/
https://www.youtube.com/channel/UCi7_WxajoowBl4_9P0DhzzA/featured
Using Selective Memory Approach
...
weigths_filename = "LunarLander-SM-weights.h5"
apWeights_filename = "LunarLander-SM-weights-ap.h5"
    ...
    for game in range(num_games_to_play):
        ...
        for step in range (1500):
            ...
            if done :
                ...
                #selective Memeory
                for i in range(0,gameR.shape[0]):
                    if addToMemory(gameR[i][0],-70,50):
