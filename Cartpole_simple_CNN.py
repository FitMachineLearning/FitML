...
This is the simplified version of the open AI problem. This solution does not use LSTMs but uses 
One Dense RELU and one Dense sigmoid instead.

It does not perform as well as the LSTM model which is better able to do longer term predictions.
...
model = Sequential()
model.add(Dense(16, activation='relu', input_dim=dataX.shape[1]))
...
if load_previous_weights:
    ...
    fn = dir_path + "/CP-weights_Simple_CNN.h5"
    print("filepath ", fn)
    if  os.path.isfile(fn):
        print("loading weights")
        model.load_weights("CP-weights_Simple_CNN.h5")
    else:
...
if save_weights:
    ...
    model.save_weights("CP-weights_Simple_CNN.h5")
