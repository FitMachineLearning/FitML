'''
LunarLanderContinuous Walker with
 - Selective Memory
 - Actor Critic
 - Parameter Noising
 - Q as discriminator
...
Update
Deep Network
Starts Landing consistantly after episode 500
...
for game in range(num_games_to_play):
    ...
    if game > num_initial_observation and uses_parameter_noising:
        ...
        if (game%1==0 ):
            is_noisy_game = True
            if is_last_noisy_game_bad or game%10==0:
    ...
    for step in range (5000):
        ...
        if done:
            ...
            if game%5 ==0 and np.alen(memoryR)>1000:
                ...
                mAverageScores.append(max(memoryR.mean(), -50))
