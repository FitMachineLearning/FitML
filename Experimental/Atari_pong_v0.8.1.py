...
Using Deep QN (Thi solution does not use the Selective Memory Approach)

The solution uses a concatanated succession of 2 pictures frames as input to the Value Function Estimator
'''
import numpy as np
import keras
import gym
...
weigths_filename = "Pong-QL-v2-weights.h5"
apWeights_filename = "Pong-QL-v2-weights-ap.h5"
