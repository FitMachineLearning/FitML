...
apWeights_filename = "Walker-SM-v5-weights-ap.h5"
            ...
            if done :
                ...
                for i in range(0,gameR.shape[0]):
                    ...
                    if i==gameR.shape[0]-1:
                        print("Training Game #",game, "memoryR ",memoryR.shape[0],"memoryA",memoryA.shape[0], " steps = ", step ,"last reward", r," finished with headscore ", gameR[(gameR.shape[0]-1)-i][0])
