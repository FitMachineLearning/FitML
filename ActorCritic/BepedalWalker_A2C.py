'''
BipedalWalker-v2 solution by Michel Aka
...
apWeights_filename = "BpW-v3-AP-weights.h5"
...
if observe_and_train:
    ...
    for game in range(num_games_to_play):
        ...
        for step in range (4000):
            ...
            if done:
                print("Game ended with reward ", r," steps ", step, "mem len", memoryX.shape[0],"apmem", apmemoryX.shape[0])
                if r < 0:
                    print("Game ",game," ended with - negative reward ")
                if r >= 0 and r <99:
