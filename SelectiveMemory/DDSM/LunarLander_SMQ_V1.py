...
def create1hot(a,aSize):
    retVal = np.zeros(aSize)
    retVal[a]= 1;
    return retVal
...
if observe_and_train:
    ...
    for game in range(num_games_to_play):
        ...
        for step in range (5000):
            ...
            env.render()
            qs_a = np.concatenate((qs,create1hot( a , num_env_actions )), axis=0)
